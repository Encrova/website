    ...
    <div className="min-h-screen flex items-center justify-center bg-[#090414] px-4 py-12">
      <div className="max-w-7xl w-full grid grid-cols-1 lg:grid-cols-2 gap-6 bg-transparent">
        ...
        <div className="flex flex-col text-white mt-8">
          ...
          <div className="mt-8">
            <div className="text-base mb-2 font-medium">For General Enquiries</div>
            <div className="flex items-center gap-2 text-lg text-muted-foreground">
              <Copy className="w-6 h-6" />
              <span>hello@gopidge.com</span>
            </div>
          </div>
        </div>
        {/* Right side: Form */}
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="bg-[#120b27] border border-gray-800 rounded-2xl shadow-lg p-8 flex flex-col gap-6 text-white">
            <div className="-mb-3">
              <span className="text-xs font-semibold tracking-widest text-white">BOOK A MEETING</span>
            </div>
                    ...
                    <FormControl>
                      <Select onValueChange={field.onChange} defaultValue={field.value} required>
                        <SelectTrigger className="bg-[#120b27] border border-gray-800 rounded-lg !px-5 !py-4 !min-h-[56px] !text-base text-white focus:outline-none focus:border-primary min-w-0 w-full">
                          <SelectValue placeholder="Business type*" className="text-white" />
                        </SelectTrigger>
                        <SelectContent className="bg-[#090414] border border-gray-800">
                          <SelectItem value="Startup" className="text-white focus:bg-[#120b27] focus:text-white">Startup</SelectItem>
                          <SelectItem value="Enterprise" className="text-white focus:bg-[#120b27] focus:text-white">Enterprise</SelectItem>
                          <SelectItem value="Government" className="text-white focus:bg-[#120b27] focus:text-white">Government</SelectItem>
                          <SelectItem value="Investor" className="text-white focus:bg-[#120b27] focus:text-white">Investor</SelectItem>
                        </SelectContent>
                      </Select>
                    </FormControl>
                  </FormItem>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mt-2">
              <Button type="submit" className="bg-[#7c3aed] hover:bg-[#a78bfa] text-white font-semibold py-3 rounded-lg w-full sm:w-auto px-8">Submit</Button>
              <div className="text-xs text-gray-400 text-center sm:text-right w-full sm:w-auto">
                By submitting this form, I confirm that I have read and understood GoPidge's Privacy Policy.
              </div>
            </div>
          </form>
        </Form>
